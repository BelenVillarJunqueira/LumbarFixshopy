...
export const FloatingWhatsApp: React.FC<FloatingWhatsAppProps> = ({ siteContent }) => {
  ...
  return (
    <div className="fixed bottom-20 sm:bottom-6 right-4 sm:right-6 z-40 flex flex-col items-end pointer-events-none">
      {showTooltip && (
        <div className="mb-2 bg-white text-slate-800 text-xs font-semibold px-3 py-2 rounded-2xl shadow-xl border border-slate-200 flex items-center gap-2 max-w-55 animate-fade-in pointer-events-auto">
